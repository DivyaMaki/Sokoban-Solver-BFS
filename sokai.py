...
class SokobanGUI:
    ...
    def load_images(self):
        ...
        self.player_image = tk.PhotoImage(file="playerD.png")
        self.box_image = tk.PhotoImage(file="box.png")
        self.goal_image = tk.PhotoImage(file="target.png")
        self.box_on_goal_image = tk.PhotoImage(file="valid_box.png")
